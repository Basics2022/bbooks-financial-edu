...
```{dropdown} Shannon demon - on a coin flip
:open:
<!--
:label: shannon-demon
-->
...
```{dropdown} Nassin Taleb, is the coin fair?
:open:
<!--
...
```{dropdown} Does rebalancing improve return, thanks to Shannon demon?
:open:
<!--
